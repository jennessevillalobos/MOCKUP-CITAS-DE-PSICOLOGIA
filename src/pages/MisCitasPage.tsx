...
const text = {
  es: {
    ...
    pagosRevision: 'Transferencias por revisar', pagosRevisionSub: 'Verifica que el dinero llegó antes de aprobar: al aprobar se abona a la cita o, si cubre el precio, se da acceso al curso o al producto.',
  ...
  en: {
    ...
    pagosRevision: 'Transfers to review', pagosRevisionSub: 'Check the money arrived before approving: approving credits the appointment or, once the price is covered, grants access to the course or product.',
