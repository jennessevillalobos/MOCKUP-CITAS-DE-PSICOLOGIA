...
- **Esquema**: `supabase/migrations/001…015` (37 tablas, RLS en todas). Todas ya están aplicadas al proyecto; el `seed.sql` también. Una migración nueva va como `012_…sql` en el repo **y** se aplica al proyecto (no editar migraciones ya aplicadas).
